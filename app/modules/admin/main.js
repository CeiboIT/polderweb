angular.module('polderweb')
 ...
 // --------------------------------------------------------------------------------- 
 .state('adminAanhef', { url:'/admin/aanhef',                                templateUrl:'app/modules/admin/aanhef/aanhef.html',                                           controller:'AanhefController', resolve: { aanhef: function (Aanhef) { return Aanhef.findAll(); } } })
